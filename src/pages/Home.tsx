      ...
      <section className="relative overflow-hidden bg-white pt-16 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              Bergabunglah bersama {settings?.namaSekolah || 'SDN 08 PKL KERINCI'}. Kami berkomitmen memberikan pendidikan dasar terbaik dengan fasilitas modern dan tenaga pendidik profesional.
            </motion.p>
